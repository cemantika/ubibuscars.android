...
public class MinhasCaronasActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		*/
		...
		ListaMinhasCaronas lista_caronas =  new ListaMinhasCaronas();
		lista_caronas.execute();
		...
		// Launching new screen on Selecting Single ListItem
				lv.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						// Starting new intent
						Intent in = new Intent(getApplicationContext(), ExcluirCaronaActivity.class);
	...
	//requisição assincrona para listar as caronas
		public class ListaMinhasCaronas extends AsyncTask<Void, Void, ArrayList<HashMap<String, Object>>>{
			ProgressDialog aguardeCaronas = new ProgressDialog(MinhasCaronasActivity.this);
			...
			protected void onPostExecute(ArrayList<HashMap<String, Object>> result){
				...
				ListAdapter adapter = new SimpleAdapter(MinhasCaronasActivity.this, result,
						R.layout.list_item, new String[] { "nome", "endereco_origem",
								"endereco_destino", "imagem" }, new int[] {
								R.id.TextNomeUsuario, R.id.textEndOrig,
								R.id.textEndDest, R.id.imageViewTipoCarona });
